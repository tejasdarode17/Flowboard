...
import IssuesSkeleton from "../shimmer/IssueSkeleton";
  ...
  return (
    <div className="rounded-2xl border border-border/40 bg-card/50 backdrop-blur-sm overflow-hidden">
      <div className="px-6 py-4 border-b border-border/30">
        ...
        <p className="text-[13px] text-muted-foreground mt-0.5">{myIssues?.length ? "Issues assigned to you" : "No issues assigned"}</p>
      </div>
